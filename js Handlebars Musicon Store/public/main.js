...
const templateElement = document.getElementById('templateHB').innerHTML;
...
const indexElement = document.getElementById('information');
// setting element context to compiled HTML:
indexElement.innerHTML = compiledHtml;